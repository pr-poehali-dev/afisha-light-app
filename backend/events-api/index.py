            ...
            cur.execute(
                f"""INSERT INTO {SCHEMA}.events
                    (vk_group_id, title, type, tags, description, city, address, place, place_id,
                     image, vk_cover_id, vk_photo_id, age, is_free, price, price_from, price_to, online, is_past, private, dates,
        ...
        if method == 'PUT' and event_id:
            ...
            cur.execute(
                f"""UPDATE {SCHEMA}.events SET
                    ...
                    place=%s, place_id=%s, image=%s, vk_cover_id=%s, vk_photo_id=%s, age=%s, is_free=%s, price=%s, price_from=%s, price_to=%s,
